...
const MansSlidercart = () => {
    return (
        <div className='w-full max-w-7xl mx-auto mt-20 px-4 sm:px-6 lg:px-8'>
            <h1 className='text-3xl md:text-4xl mb-10 text-center md:text-left'>Mens Collection</h1>
            <Carousel
                showArrows={true}
...
const data = [
    {
        collection: "Men's Collection1",
        img: "/Mens/ShalwarKameez 2.jpg",
        pera: "Style with our exclusive range of branded clothing.",
    },
    {
        collection: "Men's Collection2",
        img: "/Mens/ShalwarKameez 2.jpg",
        pera: "Style with our exclusive range of branded clothing.",
    },
    {
        collection: "Men's Collection3",
        img: "/Mens/ShalwarKameez 4.jpg",
        pera: "Style with our exclusive range of branded clothing.",
    },
    {
        collection: "Men's Collection4",
        img: "/Mens/ShalwarKameez 5.jpg",
        pera: "Style with our exclusive range of branded clothing.",
    },
    {
        collection: "Men's Collection5",
        img: "/Mens/ShalwarKameez 9.jpg",
        pera: "Style with our exclusive range of branded clothing.",
    },
    {
        collection: "Men's Collection6",
        img: "/Mens/ShalwarKameez 10.jpg",
        pera: "Style with our exclusive range of branded clothing.",
    },
    {
        collection: "Men's Collection7",
        img: "/Mens/ShalwarKameez 2.jpg",
        pera: "Style with our exclusive range of branded clothing.",
    },
    {
        collection: "Men's Collection8",
        img: "/Mens/ShalwarKameez 2.jpg",
        pera: "Style with our exclusive range of branded clothing.",
    },
    {
