...
const Order = ({ order }) => {
  ...
  return (
    <div className="container mx-auto py-8 px-16 lg:px-24 mt-32">
      ...
      <div className='mt-4 p-4 border rounded-lg bg-gray-100'>
        ...
        <div className='space-x-2 py-1 space-y-1 text-center  mt-2'>
          <button className='bg-green-500 text-white md:py-4 md:px-6  py-1 px-6 rounded hover:bg-green-800 text-xl'>Order Tracking</button>
          <button className='bg-red-500 text-white md:py-4 md:px-6   py-1 px-3 rounded hover:bg-red-800 text-xl'>Continue Shopping</button>
        </div>
      </div>
    </div>
  );
